...
def generate_html_with_css(markdown_content):
    ...
    <header>
        ...
        <p>This report provides an overview of the code quality, style checks, and other insights generated by the <a href="https://github.com/Gchism94/jupyterquest">jupyterquest</a> autograder tool.</p> <!-- Summary text -->
    </header>
    <main>
        {content}
    </main>
